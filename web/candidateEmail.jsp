...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="${pageContext.request.contextPath}/resources/index.html">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/resources/index.html">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="${pageContext.request.contextPath}/resources/buttons.html">Buttons</a>
                        <a class="collapse-item" href="${pageContext.request.contextPath}/resources/cards.html">Cards</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="${pageContext.request.contextPath}/resources/utilities-color.html">Colors</a>
                        <a class="collapse-item" href="${pageContext.request.contextPath}/resources/utilities-border.html">Borders</a>
                        <a class="collapse-item" href="${pageContext.request.contextPath}/resources/utilities-animation.html">Animations</a>
                        <a class="collapse-item" href="${pageContext.request.contextPath}/resources/utilities-other.html">Other</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/resources/charts.html">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="${pageContext.request.contextPath}/resources/tables.html">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form class="needs-validation" action="/emailServlet" method="post" novalidate>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-outline-secondary" id="sendEmailButton">
                                        일괄 메일 전송
                                    </button>
                                </div>
                            </form>
    ...
    <script>
        ...
        const submitButton = document.querySelector(".btn.btn-outline-secondary");
